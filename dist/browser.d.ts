 ...
 * ```
 */
import { WebOcr, OcrEngine } from "./webOcr";
...
/** 当前 `browser.js` 所在目录 */
export declare function getDistBaseUrl(): string;
/** 规范化目录 URL（保证末尾 `/`） */
export declare function normalizeBaseUrl(baseUrl: string): string;
/** 根据根目录生成 assets / ort 默认地址 */
export declare function resolveAssetUrls(baseUrl?: string): {
    assetsUrl: string;
    wasmPaths: string;
};
/**
 ...
 */
export declare function createWebOcr(options?: BrowserWebOcrOptions): Promise<WebOcr>;
export { WebOcr, OcrEngine };
export type { ExecutionProviderName, OcrInput, OcrLine, OcrProgress, OcrResult, Point, TextBox, WebOcrOptions, } from "./types";
